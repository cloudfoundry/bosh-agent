...
type FakeAgentClient struct {
	...
	GetCertInfoStub        func() (interface{}, error)
	getCertInfoMutex       sync.RWMutex
	getCertInfoArgsForCall []struct{}
	getCertInfoReturns     struct {
		result1 interface{}
		result2 error
	}
	getCertInfoReturnsOnCall map[int]struct {
		result1 interface{}
		result2 error
	}
...
func (fake *FakeAgentClient) GetCertInfo() (interface{}, error) {
	fake.getCertInfoMutex.Lock()
	ret, specificReturn := fake.getCertInfoReturnsOnCall[len(fake.getCertInfoArgsForCall)]
	fake.getCertInfoArgsForCall = append(fake.getCertInfoArgsForCall, struct{}{})
	fake.recordInvocation("GetCertInfo", []interface{}{})
	fake.getCertInfoMutex.Unlock()
	if fake.GetCertInfoStub != nil {
		return fake.GetCertInfoStub()
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
	return fake.getCertInfoReturns.result1, fake.getCertInfoReturns.result2
}

func (fake *FakeAgentClient) GetCertInfoCallCount() int {
	fake.getCertInfoMutex.RLock()
	defer fake.getCertInfoMutex.RUnlock()
	return len(fake.getCertInfoArgsForCall)
}

func (fake *FakeAgentClient) GetCertInfoReturns(result1 interface{}, result2 error) {
	fake.GetCertInfoStub = nil
	fake.getCertInfoReturns = struct {
		result1 interface{}
		result2 error
	}{result1, result2}
}

func (fake *FakeAgentClient) GetCertInfoReturnsOnCall(i int, result1 interface{}, result2 error) {
	fake.GetCertInfoStub = nil
	if fake.getCertInfoReturnsOnCall == nil {
		fake.getCertInfoReturnsOnCall = make(map[int]struct {
			result1 interface{}
			result2 error
		})
	}
	fake.getCertInfoReturnsOnCall[i] = struct {
		result1 interface{}
		result2 error
	}{result1, result2}
}
