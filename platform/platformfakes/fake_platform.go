...
type FakePlatform struct {
	...
	SetupEphemeralDiskWithPathStub        func(devicePath string, desiredSwapSizeInBytes *uint64, labelPrefix string) (err error)
...
func (fake *FakePlatform) SetupEphemeralDiskWithPath(devicePath string, desiredSwapSizeInBytes *uint64, labelPrefix string) (err error) {
	...
	fake.setupEphemeralDiskWithPathArgsForCall = append(fake.setupEphemeralDiskWithPathArgsForCall, struct {
		...
		desiredSwapSizeInBytes *uint64
		labelPrefix            string
	}{devicePath, desiredSwapSizeInBytes, labelPrefix})
	fake.recordInvocation("SetupEphemeralDiskWithPath", []interface{}{devicePath, desiredSwapSizeInBytes, labelPrefix})
	fake.setupEphemeralDiskWithPathMutex.Unlock()
	if fake.SetupEphemeralDiskWithPathStub != nil {
		return fake.SetupEphemeralDiskWithPathStub(devicePath, desiredSwapSizeInBytes, labelPrefix)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakePlatform) SetupEphemeralDiskWithPathArgsForCall(i int) (string, *uint64, string) {
	fake.setupEphemeralDiskWithPathMutex.RLock()
	defer fake.setupEphemeralDiskWithPathMutex.RUnlock()
	return fake.setupEphemeralDiskWithPathArgsForCall[i].devicePath, fake.setupEphemeralDiskWithPathArgsForCall[i].desiredSwapSizeInBytes, fake.setupEphemeralDiskWithPathArgsForCall[i].labelPrefix
}
