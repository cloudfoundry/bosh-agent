...
type Partitioner interface {
	...
	PartitionsNeedResize(devicePath string, partitions []Partition) (needsResize bool, err error)
	ResizePartitions(devicePath string, partitions []Partition) (err error)
