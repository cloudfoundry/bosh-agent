...
func (net UbuntuNetManager) writeNetworkInterfaces(
	...
	for _, staticAddressConfiguration := range staticConfigs {
		...
		changed, err := net.updateConfiguration(staticAddressConfiguration.Name, systemdStaticNetworkTemplate, networkInterfaceConfiguration, opts)
		if err != nil {
...
const systemdStaticNetworkTemplate = `# Generated by bosh-agent
[Match]
